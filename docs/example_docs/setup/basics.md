...
At this point, you now have your DrugDiscMDConformers repository on GitHub and locally on your machine. Now it's time to start making some modifications.
...
The DrugDiscMDConformers repository comes premade with a sample license (`/LICENSE.md`), in this case the very popular and permissive [BSD 3-Clause license](https://opensource.org/license/bsd-3-clause/). Feel free to change this for your own project or keep it as-is if you don't quite know yet.
